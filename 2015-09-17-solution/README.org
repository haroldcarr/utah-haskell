...
#+BEGIN_EXAMPLE
let msg = Msg "Your Name" 0 "some message text"
#+END_EXAMPLE
...
Messages to the service can be sent (and responses captured) via:

#+BEGIN_EXAMPLE
r <- post "http://127.0.0.1:3000" jsn
#+END_EXAMPLE

You can examine the response using techniques shown in the Wreq tutorial:
